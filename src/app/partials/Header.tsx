			...
			<nav className="border-gray-200 py-2.5 px-4 dark:bg-gray-800 rounded-lg shadow">
				<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
					<a href="#" className="flex items-center">
						<Image src={makeImagePath("/assets/d.png")} className="mr-3 h-6 sm:h-9" alt="FluentDash" width={60} height={80} />
						<span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white italic">FluentDash</span>
					</a>
					<div className="flex items-center lg:order-2">
						{/* */}
						<Tooltip content="Finds the closest Fluent v9 color token" relationship="description">
						...
						<Tooltip content="Coming soon" relationship="description">
							<a href="#" className="text-gray-300 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
								Contrast Checker
							</a>
						</Tooltip>
						{/* * /}
